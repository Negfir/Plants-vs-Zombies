 ...
 * @author negin
 */
public class ThirdLevel extends JPanel implements Runnable {
    ...
    public ThirdLevel(Dimension screen, MyFrame frame) {
        this.frame = frame;
        this.screen = screen;
            ...
            case 2:
                switch (num) {
                    case 1:
                        ...
                        break;
                    case 2:
                        zombies.add(new AthleteZ(900, 150, 100, 2));
                        break;
                    case 3:
            ...
            case 3:
                switch (num) {
                    case 1:
                        ...
                        break;
                    case 2:
                        zombies.add(new AthleteZ(900, 250, 100, 2));
                        break;
                    case 3:
            ...
            case 4:
                switch (num) {
                    case 1:
                        ...
                        break;
                    case 2:
                        zombies.add(new AthleteZ(900, 350, 100, 2));
                        break;
                    case 3:
            ...
            case 5:
                switch (num) {
                    case 1:
                        ...
                        break;
                    case 2:
                        zombies.add(new AthleteZ(900, 450, 100, 2));
                        break;
                    case 3:
