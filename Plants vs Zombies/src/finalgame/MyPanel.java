...
public class MyPanel extends JPanel implements Runnable {
    ...
    public MyPanel(Dimension screen, MyFrame frame) {
        this.frame = frame;
        this.screen = screen;
        ...
        cherryButton.setBounds(0, 230, 65, 88);
        wallNuttButton.setBounds(0, 320, 65, 88);
        ...
        cherryButton.addActionListener(handler);
        snowPeaButton.addActionListener(handler);
            ...
            case 1:
                switch (num) {
                    ...
                    case 2:
                        ...
                        zombies.add(new AthleteZ(900, 50, 100, 3));
                        break;
                    case 3:
                    ...
                    default:
                        zombies.add(new ThrowZ(900, 50, 100, 2));
                        break;
            ...
            case 2:
                switch (num) {
                    case 1:
                        ...
                        break;
                    case 2:
                        zombies.add(new AthleteZ(900, 150, 100, 3));
                        break;
                    case 3:
                        ...
                        break;
                    default:
                        zombies.add(new ThrowZ(900, 150, 100, 2));
                        break;
            ...
            case 3:
                switch (num) {
                    case 1:
                        ...
                        break;
                    case 2:
                        zombies.add(new AthleteZ(900, 250, 100, 3));
                        break;
                    case 3:
                        zombies.add(new TypicalZ(900, 250, 100, 2));
                        break;
                    default:
                        zombies.add(new ThrowZ(900, 250, 100, 2));
                        break;
            ...
            case 4:
                switch (num) {
                    case 1:
                        ...
                        break;
                    case 2:
                        zombies.add(new AthleteZ(900, 350, 100, 3));
                        break;
                    case 3:
                        zombies.add(new TypicalZ(900, 350, 100, 2));
                        break;
                    default:
                        zombies.add(new ThrowZ(900, 350, 100, 2));
                        break;
            ...
            case 5:
                switch (num) {
                    case 1:
                        ...
                        break;
                    case 2:
                        zombies.add(new AthleteZ(900, 450, 100, 3));
                        break;
                    case 3:
                        zombies.add( new TypicalZ(900, 450, 100, 2));
                        break;
                    default:
                        zombies.add(new ThrowZ(900, 450, 100, 2));
                        break;
                    ...
                    for (Zombies j : zombies) {
                        if(j instanceof AthleteZ &&((AthleteZ) j).b ){
                          ...
                          ((AthleteZ) j).b=false;
                           ...
                           if (j.isIs_Alive() && i.is_Alive) {
                            if (i.getX()+60  < j.getX() && j.getX() < i.getX() + 80 && i.getY()  < j.getY() && j.getY() < i.getY() + 50) {
                                Thread t = new Thread() {
                                    public void run() {
